...
export class AppComponent implements OnInit {
  ...
  // Promise é simples, ela tem apenas dois retornos, sucesso ou falha
  minhaPromise(nome: string) : Promise<string>{        
    return new Promise((resolve, reject) => {
      if(nome === 'Eduardo'){
        ...
        reject('Ops! Você não é a Daiane');
      }
    })
  }
/*
    ngOnInit(): void {
      this.minhaPromise('Daiane')
...
//Observable é mais complexo, ele pode ter vários retornos, sucesso, falha e conclusão
  ...
  */
    ...
    /*const obs = this.minhaObservable('Daiane');
